...
void cFrame::Update( D3DXMATRIXA16* pmatParent, int nKey )
{
	...
	LocalTMatrix(matT, nKey);
	LocalRMatrix(matR, nKey);
	if(!pmatParent)
	{
		D3DXMatrixIdentity(&matR);
	}
// 	char sz[1024];
// 	sprintf(sz, "%f, %f, %f\n", matT._31,matT._32,matT._33);
...
void cFrame::Render()
{
	...
	if(!pMesh)
	{
		D3DXCreateBox(g_pD3DDevice, 0.1, 0.1, 0.1, &pMesh, NULL);
	}
...
void cFrame::LocalTMatrix( OUT D3DXMATRIXA16& mat, IN int nKey )
{
...
void cFrame::LocalRMatrix( OUT D3DXMATRIXA16& mat, IN int nKey )
{
